...
# Installing Basler Plugin Installation Dependencies
RUN apt-get -y install automake

# Adding Basler Plugin Installation Dependencies
COPY basler-source-plugin ./basler-source-plugin

# Installing Gstreamer Basler Plugin
...
# Removing Basler Plugin Sources
RUN rm -rf basler-source-plugin/
